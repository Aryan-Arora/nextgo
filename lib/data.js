...
export const TABLES = {
  ...
  wallet: {
    ...
    rows: [
      [['t', '03 Sep, 09:12'], ['t', 'Freight · Delhivery Surface', 'AWB 2839471056283'], ['m', 'TXN-9928410'], ['n', '₹168.15'], ['n', '—'], ['n', '₹42,977.00']],
      [['t', '03 Sep, 08:58'], ['t', 'Freight · Blue Dart Air', 'AWB 7712004488390'], ['m', 'TXN-9928402'], ['n', '₹316.24'], ['n', '—'], ['n', '₹43,145.15']],
      [['t', '02 Sep, 19:34'], ['t', 'Weight discrepancy hold', 'AWB 2839471029844'], ['m', 'TXN-9927881'], ['n', '₹186.00'], ['n', '—'], ['n', '₹43,461.39']],
      [['t', '02 Sep, 16:20'], ['t', 'RTO freight · Ekart', 'AWB EK9930409112'], ['m', 'TXN-9927744'], ['n', '₹231.28'], ['n', '—'], ['n', '₹43,647.39']],
      [['t', '01 Sep, 09:14'], ['t', 'Wallet recharge · NEFT', 'HDFC ••4412'], ['m', 'RZP-4482910'], ['n', '—'], ['n', '₹50,000.00'], ['n', '₹43,878.67']],
      [['t', '31 Aug, 22:04'], ['t', 'Dispute won · refund', 'AWB ECOM88208012'], ['m', 'TXN-9925012'], ['n', '—'], ['n', '₹58.00'], ['n', '₹-6,121.33']],
      [['t', '31 Aug, 17:41'], ['t', 'Freight · XpressBees Surface', 'AWB XB4471209934'], ['m', 'TXN-9924880'], ['n', '₹217.71'], ['n', '—'], ['n', '₹-6,179.33']],
    ],
  },
  'a-sellers': {
  ...
  'a-jobs': {
    ...
    rows: [
      ...
      [['m', 'RUN-99284009'], ['t', 'Invoice generation'], ['t', 'Aug 2026 cycle'], ['t', '08:30:00'], ['n', '—'], ['n', '1,284'], ['s', 'Queued'], ['l', 'Logs']],
    ],
  },
};
...
export const CONNECTORS = {
  ...
  opencart: ['OpenCart', 'Storefront', 'Not connected', '—', 'Never synced', 'REST extension 4.x', ['—', '—', '—', '—']],
  magento: ['Magento', 'Storefront', 'Not connected', '—', 'Never synced', 'Adobe Commerce 2.4', ['—', '—', '—', '—']],
